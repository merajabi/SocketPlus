...
g++ -std=c++11 -static -static-libgcc -static-libstdc++ -Iinclude/ src/*.cpp test/client1.cpp -o client.exe -lws2_32 -lmswsock -ladvapi32 -liphlpapi
g++ -std=c++11 -static -static-libgcc -static-libstdc++ -Iinclude/ src/*.cpp test/server0.cpp -o server.exe -lws2_32 -lmswsock -ladvapi32 -liphlpapi
